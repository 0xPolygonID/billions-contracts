...
cast call 0x7F6023A048ABc80698185329Fb931B18D6A6bBa6 "u512ModexpU256(bytes,bytes,bytes)(bytes,bytes)" \
...
# cast call 0x7F6023A048ABc80698185329Fb931B18D6A6bBa6 "callBigModExp(bytes32,bytes32,bytes32)(bytes32)" \
...
cast call 0x7F6023A048ABc80698185329Fb931B18D6A6bBa6 "modExp(bytes,bytes,bytes)(bytes)" \
0x03 \
0x02 \
0x05 \
--rpc-url https://rpc.cardona.zkevm-rpc.com
