...
async function main() {
    ...
    const deployedAddressesPath = path.join(
      ...
      const aadhaarCredentialIssuerAddress =
        deployedAddresses[
            `UpgradeAnonAadhaarCredentialIssuerModule${version}#AnonAadhaarCredentialIssuer`
        ];
  await verifyContract(aadhaarCredentialIssuerAddress, {
