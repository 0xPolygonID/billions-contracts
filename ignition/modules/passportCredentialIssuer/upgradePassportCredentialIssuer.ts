...
export default buildModule("UpgradePassportCredentialIssuerV1_0_0", (m) => { // Update the version as needed
  ...
  const stateContractAddress = "0xaea923d71Bc5ED3A622D4DfCF2f9C338889b1c70"; //"0x1a4cC30f2aA0377b0c3bc9848766D90cb4404124"; //"0x3C9acB2205Aa72A05F6D77d708b5Cf85FCa3a896"; //"0x1a4cC30f2aA0377b0c3bc9848766D90cb4404124"; // "<StateContractAddress>"; // Replace with actual state contract address
  const idType = "0x0112"; //"0x0113"; //"0x01B2"; // "0x0113";
  ...
  const initializeData = m.encodeFunctionCall(newPassportCredentialIssuerImpl, "initializeIssuer", [
    expirationTime,
    templateRoot,
    [],
    [],
