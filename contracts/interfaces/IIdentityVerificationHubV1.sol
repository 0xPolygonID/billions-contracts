...
import {ISignatureCircuitVerifier} from "./ISignatureCircuitVerifier.sol";
...
interface IIdentityVerificationHubV1 {
     ...
     * @param signatureCircuitVerifierId The identifier for the signature circuit verifier to be used.
     * @param signatureCircuitProof The proof data for the signature circuit.
     */
    ...
    /**
     * @notice Retrieves the signature circuit verifier for a given signature type.
     * @param typeId The signature type identifier.
     * @return verifier The address of the signature circuit verifier.
     */
